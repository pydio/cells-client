...
// This is a fork of the github.com/pydio/cells/common/service/frontend/struct.go file 
// to ease manipulation of the registry without adding all transitive dependencies of the frontend package.
